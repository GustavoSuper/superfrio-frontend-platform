...
export default function List_Itemunidade({ history }) {
...
const goToPage = (state) => {
  history.push('/itemunidade/' + state._id);
};
    ...
    <div>
        <div className="content-wrapper">
            ...
            <section className="content-header">
                <h1>
                    Itens Unidade<small>( tabela itens )</small>
                </h1>
            </section>
            ...
            <section className="content">
                <div className="row">
                    <div className="col-xs-12">
                        ...
                        <button type="button" class="btn btn-success btn-flat margin" onClick={() => {history.push('/itemunidade/novo')}}>Novo Item</button>
