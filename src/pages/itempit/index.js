...
async function loadProd() {
  const query = '/checklistitemdefault/type/pit';
...
const goToPage = (state) => {
  history.push('/itempit/' + state._id);
};
    ...
    <div>
        <div className="content-wrapper">
            ...
            <section className="content-header">
                <h1>
                    Itens Compressor<small>( tabela itens )</small>
                </h1>
            </section>
            ...
            <section className="content">
                <div className="row">
                    <div className="col-xs-12">
                        ...
                        <button type="button" class="btn btn-success btn-flat margin" onClick={() => {history.push('/itempit/novo')}}>Novo Item</button>
