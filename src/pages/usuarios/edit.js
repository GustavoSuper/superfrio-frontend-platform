...
export default function Edit_Usuario({ history }) {
    ...
    async function loadProd() {
        ...
        const response = await api.get('/usuarios/'+param[4]);
        const data = await response.data;
        ...
        setCentro_custo(data[0].centro_custo);
        setAdmin(data[0].admin);
        setAccess_web(data[0].access_web);
        setAccess_app(data[0].access_app);
        setAccess_comp(data[0].access_comp);
        setAccess_pit(data[0].access_pit);
        setAccess_rack(data[0].access_rack);
        setAccess_desp(data[0].access_despesa);
        setWeb_appr(data[0].web_appr);
        setDesp_appr(data[0].desp_appr);
        setDesp_apprNot(data[0].receive_final_despesa);
        setArea(data[0].area);
        setIdarea(data[0].idarea);
