...
export default function New_ChecklistUnidade({ history }) {
  ...
  useEffect(() => {
    ...
    loadGas();
    setTimeout(() => {
      if (document.getElementById("menu_asunidades_novo")) {
        document.getElementById("menu_asunidades_novo").className = "active";
      }
    }, 50);
    setLoading(false);
  }, []);
                ...
                <form className="form-horizontal" onSubmit={handleSubmit}>
                  ...
                  <div className="box-footer">
                    <button
                      ...
                      style={{ marginRight: 8 }}
                      onClick={() => history.push("/checklistracksunidades")}
                    >
                      Voltar
                    </button>
