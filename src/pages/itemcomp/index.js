...
export default function List_Itemcomp({ history }) {
...
async function loadProd() {
  const query = '/checklistitemdefault/type/comp';
...
const goToPage = (state) => {
  history.push('/itemcomp/' + state._id);
};
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      if(document.getElementById('menu_itenschecklistcomp')){
        document.getElementById('menu_itenschecklistcomp').className = "active";
      }      
    }, 50);
  }, []);
    ...
    <div>
        <div className="content-wrapper">
            ...
            <section className="content-header">
                <h1>
                    Itens Entrada Compressor<small>( tabela itens )</small>
                </h1>
            </section>
            ...
            <section className="content">
                <div className="row">
                    <div className="col-xs-12">
                        ...
                        <button type="button" class="btn btn-success btn-flat margin" onClick={() => {history.push('/itemcomp/novo')}}>Novo Item</button>
